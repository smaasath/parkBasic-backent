"""
Django settings for parkBasic project.
...
SECRET_KEY = 'django-insecure-f_@y8@o6at%gw9!y10=aeu94@w@94xa^pf$rbmukfuz5-ps$2%'
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'rest_framework',
    "park_basic.apps.ParkBasicConfig",
...
WSGI_APPLICATION = 'parkBasic.wsgi.application'
